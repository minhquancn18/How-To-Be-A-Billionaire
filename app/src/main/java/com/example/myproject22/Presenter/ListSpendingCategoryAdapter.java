...
public class ListSpendingCategoryAdapter extends BaseAdapter {
    private ArrayList<SpendingCategoryClass> parentList;
    private Context context;

    public ListSpendingCategoryAdapter(ArrayList<SpendingCategoryClass> parentList, Context context){
