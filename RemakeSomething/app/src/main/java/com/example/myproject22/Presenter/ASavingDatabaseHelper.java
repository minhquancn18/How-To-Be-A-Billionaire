...
public class ASavingDatabaseHelper extends SQLiteOpenHelper {
    ...
    public ASavingDatabaseHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
